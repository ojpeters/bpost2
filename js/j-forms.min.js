...
function onPhotoDataSuccess(imageURI) {
 ...
 $('#j-forms #response').html("pic captured");
		...
		$('#mimage').append("<img with='50' height='50' src="+imageURI+" />");
...
function postData() {
	...
	var target="http://www.freewebsiteinstallations.com/app/dopost.php";
...
function uploadPhoto(imageURI,newsid) {
	...
	if($.isNumeric(newsid)){
		...
		ft.upload(imageURI, encodeURI("http://www.freewebsiteinstallations.com/app/updatepost.php"), uploadsuccess, fail, options);
